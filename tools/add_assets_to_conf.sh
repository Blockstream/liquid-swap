...
# Adds the newly created Proposer asset and adds it to Respondent liquid.conf
# Adds the newly created Respondent asset and adds it to Proposer liquid.conf
